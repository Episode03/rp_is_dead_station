...
/datum/techweb_node/cloning
	...
	assigned_departments = list("Science", "Medical")
...
/datum/techweb_node/adv_cryotech
	...
	assigned_departments = list("Medical")
...
/datum/techweb_node/plumbing
	...
	assigned_departments = list("Medical", "Service")
...
/datum/techweb_node/cyber_implants
	...
	assigned_departments = list("Medical", "Science")
